    ...
    <main>
      ...
      <section className="features">
        ...
        <div className="feature-item">
          ...
          <p>Need to talk to a representative? You can get in touch through our 24/7 chat or a phone call.</p>
        </div>
        <div className="feature-item">
        ...
        <div className="feature-item">
          ...
          <p>We use top of the line encryption to make sure your data and money are always safe.</p>
        </div>
      </section>
    </main>
  );
